...
const MASK_ROOK: [Bitboard; SQUARE_COUNT] = {
...
const MAGIC_ROOK: [u64; SQUARE_COUNT] = {
    [
        0x2492f03ba449770b,
        0x8a257639fa93076f,
        0x35075a7f00603507,
...
const SHIFT_ROOK: [u8; SQUARE_COUNT] = {
    [
        13, 12, 12, 12, 12, 12, 12, 13, 12, 11, 11, 11, 10, 11, 10, 11, 12, 11, 10, 11, 10, 11, 10,
        11, 12, 11, 10, 11, 11, 11, 10, 11, 12, 11, 11, 11, 11, 11, 10, 11, 12, 10, 10, 11, 11, 11,
        10, 11, 11, 10, 10, 10, 11, 11, 10, 11, 12, 11, 11, 11, 11, 12, 11, 12,
    ]
};
const ROOK_BB_A1: [Bitboard; (1 << SHIFT_ROOK[Square::A1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::A1 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::A1 as usize]) as usize];
...
const ROOK_BB_B1: [Bitboard; (1 << SHIFT_ROOK[Square::B1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::B1 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::B1 as usize]) as usize];
...
const ROOK_BB_C1: [Bitboard; (1 << SHIFT_ROOK[Square::C1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::C1 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::C1 as usize]) as usize];
...
const ROOK_BB_D1: [Bitboard; (1 << SHIFT_ROOK[Square::D1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::D1 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::D1 as usize]) as usize];
...
const ROOK_BB_E1: [Bitboard; (1 << SHIFT_ROOK[Square::E1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::E1 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::E1 as usize]) as usize];
...
const ROOK_BB_F1: [Bitboard; (1 << SHIFT_ROOK[Square::F1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::F1 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::F1 as usize]) as usize];
...
const ROOK_BB_G1: [Bitboard; (1 << SHIFT_ROOK[Square::G1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::G1 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::G1 as usize]) as usize];
...
const ROOK_BB_H1: [Bitboard; (1 << SHIFT_ROOK[Square::H1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::H1 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::H1 as usize]) as usize];
...
const ROOK_BB_A2: [Bitboard; (1 << SHIFT_ROOK[Square::A2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::A2 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::A2 as usize]) as usize];
...
const ROOK_BB_B2: [Bitboard; (1 << SHIFT_ROOK[Square::B2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::B2 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::B2 as usize]) as usize];
...
const ROOK_BB_C2: [Bitboard; (1 << SHIFT_ROOK[Square::C2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::C2 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::C2 as usize]) as usize];
...
const ROOK_BB_D2: [Bitboard; (1 << SHIFT_ROOK[Square::D2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::D2 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::D2 as usize]) as usize];
...
const ROOK_BB_E2: [Bitboard; (1 << SHIFT_ROOK[Square::E2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::E2 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::E2 as usize]) as usize];
...
const ROOK_BB_F2: [Bitboard; (1 << SHIFT_ROOK[Square::F2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::F2 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::F2 as usize]) as usize];
...
const ROOK_BB_G2: [Bitboard; (1 << SHIFT_ROOK[Square::G2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::G2 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::G2 as usize]) as usize];
...
const ROOK_BB_H2: [Bitboard; (1 << SHIFT_ROOK[Square::H2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::H2 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::H2 as usize]) as usize];
...
const ROOK_BB_A3: [Bitboard; (1 << SHIFT_ROOK[Square::A3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::A3 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::A3 as usize]) as usize];
...
const ROOK_BB_B3: [Bitboard; (1 << SHIFT_ROOK[Square::B3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::B3 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::B3 as usize]) as usize];
...
const ROOK_BB_C3: [Bitboard; (1 << SHIFT_ROOK[Square::C3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::C3 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::C3 as usize]) as usize];
...
const ROOK_BB_D3: [Bitboard; (1 << SHIFT_ROOK[Square::D3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::D3 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::D3 as usize]) as usize];
...
const ROOK_BB_E3: [Bitboard; (1 << SHIFT_ROOK[Square::E3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::E3 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::E3 as usize]) as usize];
...
const ROOK_BB_F3: [Bitboard; (1 << SHIFT_ROOK[Square::F3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::F3 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::F3 as usize]) as usize];
...
const ROOK_BB_G3: [Bitboard; (1 << SHIFT_ROOK[Square::G3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::G3 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::G3 as usize]) as usize];
...
const ROOK_BB_H3: [Bitboard; (1 << SHIFT_ROOK[Square::H3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::H3 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::H3 as usize]) as usize];
...
const ROOK_BB_A4: [Bitboard; (1 << SHIFT_ROOK[Square::A4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::A4 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::A4 as usize]) as usize];
...
const ROOK_BB_B4: [Bitboard; (1 << SHIFT_ROOK[Square::B4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::B4 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::B4 as usize]) as usize];
...
const ROOK_BB_C4: [Bitboard; (1 << SHIFT_ROOK[Square::C4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::C4 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::C4 as usize]) as usize];
...
const ROOK_BB_D4: [Bitboard; (1 << SHIFT_ROOK[Square::D4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::D4 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::D4 as usize]) as usize];
...
const ROOK_BB_E4: [Bitboard; (1 << SHIFT_ROOK[Square::E4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::E4 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::E4 as usize]) as usize];
...
const ROOK_BB_F4: [Bitboard; (1 << SHIFT_ROOK[Square::F4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::F4 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::F4 as usize]) as usize];
...
const ROOK_BB_G4: [Bitboard; (1 << SHIFT_ROOK[Square::G4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::G4 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::G4 as usize]) as usize];
...
const ROOK_BB_H4: [Bitboard; (1 << SHIFT_ROOK[Square::H4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::H4 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::H4 as usize]) as usize];
...
const ROOK_BB_A5: [Bitboard; (1 << SHIFT_ROOK[Square::A5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::A5 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::A5 as usize]) as usize];
...
const ROOK_BB_B5: [Bitboard; (1 << SHIFT_ROOK[Square::B5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::B5 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::B5 as usize]) as usize];
...
const ROOK_BB_C5: [Bitboard; (1 << SHIFT_ROOK[Square::C5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::C5 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::C5 as usize]) as usize];
...
const ROOK_BB_D5: [Bitboard; (1 << SHIFT_ROOK[Square::D5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::D5 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::D5 as usize]) as usize];
...
const ROOK_BB_E5: [Bitboard; (1 << SHIFT_ROOK[Square::E5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::E5 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::E5 as usize]) as usize];
...
const ROOK_BB_F5: [Bitboard; (1 << SHIFT_ROOK[Square::F5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::F5 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::F5 as usize]) as usize];
...
const ROOK_BB_G5: [Bitboard; (1 << SHIFT_ROOK[Square::G5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::G5 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::G5 as usize]) as usize];
...
const ROOK_BB_H5: [Bitboard; (1 << SHIFT_ROOK[Square::H5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::H5 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::H5 as usize]) as usize];
...
const ROOK_BB_A6: [Bitboard; (1 << SHIFT_ROOK[Square::A6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::A6 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::A6 as usize]) as usize];
...
const ROOK_BB_B6: [Bitboard; (1 << SHIFT_ROOK[Square::B6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::B6 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::B6 as usize]) as usize];
...
const ROOK_BB_C6: [Bitboard; (1 << SHIFT_ROOK[Square::C6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::C6 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::C6 as usize]) as usize];
...
const ROOK_BB_D6: [Bitboard; (1 << SHIFT_ROOK[Square::D6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::D6 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::D6 as usize]) as usize];
...
const ROOK_BB_E6: [Bitboard; (1 << SHIFT_ROOK[Square::E6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::E6 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::E6 as usize]) as usize];
...
const ROOK_BB_F6: [Bitboard; (1 << SHIFT_ROOK[Square::F6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::F6 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::F6 as usize]) as usize];
...
const ROOK_BB_G6: [Bitboard; (1 << SHIFT_ROOK[Square::G6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::G6 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::G6 as usize]) as usize];
...
const ROOK_BB_H6: [Bitboard; (1 << SHIFT_ROOK[Square::H6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::H6 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::H6 as usize]) as usize];
...
const ROOK_BB_A7: [Bitboard; (1 << SHIFT_ROOK[Square::A7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::A7 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::A7 as usize]) as usize];
...
const ROOK_BB_B7: [Bitboard; (1 << SHIFT_ROOK[Square::B7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::B7 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::B7 as usize]) as usize];
...
const ROOK_BB_C7: [Bitboard; (1 << SHIFT_ROOK[Square::C7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::C7 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::C7 as usize]) as usize];
...
const ROOK_BB_D7: [Bitboard; (1 << SHIFT_ROOK[Square::D7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::D7 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::D7 as usize]) as usize];
...
const ROOK_BB_E7: [Bitboard; (1 << SHIFT_ROOK[Square::E7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::E7 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::E7 as usize]) as usize];
...
const ROOK_BB_F7: [Bitboard; (1 << SHIFT_ROOK[Square::F7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::F7 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::F7 as usize]) as usize];
...
const ROOK_BB_G7: [Bitboard; (1 << SHIFT_ROOK[Square::G7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::G7 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::G7 as usize]) as usize];
...
const ROOK_BB_H7: [Bitboard; (1 << SHIFT_ROOK[Square::H7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::H7 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::H7 as usize]) as usize];
...
const ROOK_BB_A8: [Bitboard; (1 << SHIFT_ROOK[Square::A8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::A8 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::A8 as usize]) as usize];
...
const ROOK_BB_B8: [Bitboard; (1 << SHIFT_ROOK[Square::B8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::B8 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::B8 as usize]) as usize];
...
const ROOK_BB_C8: [Bitboard; (1 << SHIFT_ROOK[Square::C8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::C8 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::C8 as usize]) as usize];
...
const ROOK_BB_D8: [Bitboard; (1 << SHIFT_ROOK[Square::D8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::D8 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::D8 as usize]) as usize];
...
const ROOK_BB_E8: [Bitboard; (1 << SHIFT_ROOK[Square::E8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::E8 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::E8 as usize]) as usize];
...
const ROOK_BB_F8: [Bitboard; (1 << SHIFT_ROOK[Square::F8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::F8 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::F8 as usize]) as usize];
...
const ROOK_BB_G8: [Bitboard; (1 << SHIFT_ROOK[Square::G8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::G8 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::G8 as usize]) as usize];
...
const ROOK_BB_H8: [Bitboard; (1 << SHIFT_ROOK[Square::H8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_ROOK[Square::H8 as usize]) as usize] =
        [0u64; (1 << SHIFT_ROOK[Square::H8 as usize]) as usize];
