...
const MASK_BISHOP: [Bitboard; SQUARE_COUNT] = {
...
const MAGIC_BISHOP: [u64; SQUARE_COUNT] = {
    [
        0xd358eacff6ef9bff,
        0xb90589d7cab7fa4a,
        0x719cc7cf93f9697e,
...
const SHIFT_BISHOP: [u8; SQUARE_COUNT] = {
    [
        5, 4, 5, 5, 5, 5, 4, 5, 4, 4, 5, 5, 5, 5, 4, 4, 4, 4, 7, 7, 7, 7, 4, 4, 5, 5, 7, 9, 9, 7,
        5, 5, 5, 5, 7, 9, 9, 7, 5, 5, 4, 4, 7, 7, 7, 7, 4, 4, 4, 4, 5, 5, 5, 5, 4, 4, 5, 4, 5, 5,
        5, 5, 4, 5,
    ]
};
const BISHOP_BB_A1: [Bitboard; (1 << SHIFT_BISHOP[Square::A1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::A1 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::A1 as usize]) as usize];
...
const BISHOP_BB_B1: [Bitboard; (1 << SHIFT_BISHOP[Square::B1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::B1 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::B1 as usize]) as usize];
...
const BISHOP_BB_C1: [Bitboard; (1 << SHIFT_BISHOP[Square::C1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::C1 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::C1 as usize]) as usize];
...
const BISHOP_BB_D1: [Bitboard; (1 << SHIFT_BISHOP[Square::D1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::D1 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::D1 as usize]) as usize];
...
const BISHOP_BB_E1: [Bitboard; (1 << SHIFT_BISHOP[Square::E1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::E1 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::E1 as usize]) as usize];
...
const BISHOP_BB_F1: [Bitboard; (1 << SHIFT_BISHOP[Square::F1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::F1 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::F1 as usize]) as usize];
...
const BISHOP_BB_G1: [Bitboard; (1 << SHIFT_BISHOP[Square::G1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::G1 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::G1 as usize]) as usize];
...
const BISHOP_BB_H1: [Bitboard; (1 << SHIFT_BISHOP[Square::H1 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::H1 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::H1 as usize]) as usize];
...
const BISHOP_BB_A2: [Bitboard; (1 << SHIFT_BISHOP[Square::A2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::A2 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::A2 as usize]) as usize];
...
const BISHOP_BB_B2: [Bitboard; (1 << SHIFT_BISHOP[Square::B2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::B2 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::B2 as usize]) as usize];
...
const BISHOP_BB_C2: [Bitboard; (1 << SHIFT_BISHOP[Square::C2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::C2 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::C2 as usize]) as usize];
...
const BISHOP_BB_D2: [Bitboard; (1 << SHIFT_BISHOP[Square::D2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::D2 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::D2 as usize]) as usize];
...
const BISHOP_BB_E2: [Bitboard; (1 << SHIFT_BISHOP[Square::E2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::E2 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::E2 as usize]) as usize];
...
const BISHOP_BB_F2: [Bitboard; (1 << SHIFT_BISHOP[Square::F2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::F2 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::F2 as usize]) as usize];
...
const BISHOP_BB_G2: [Bitboard; (1 << SHIFT_BISHOP[Square::G2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::G2 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::G2 as usize]) as usize];
...
const BISHOP_BB_H2: [Bitboard; (1 << SHIFT_BISHOP[Square::H2 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::H2 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::H2 as usize]) as usize];
...
const BISHOP_BB_A3: [Bitboard; (1 << SHIFT_BISHOP[Square::A3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::A3 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::A3 as usize]) as usize];
...
const BISHOP_BB_B3: [Bitboard; (1 << SHIFT_BISHOP[Square::B3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::B3 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::B3 as usize]) as usize];
...
const BISHOP_BB_C3: [Bitboard; (1 << SHIFT_BISHOP[Square::C3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::C3 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::C3 as usize]) as usize];
...
const BISHOP_BB_D3: [Bitboard; (1 << SHIFT_BISHOP[Square::D3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::D3 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::D3 as usize]) as usize];
...
const BISHOP_BB_E3: [Bitboard; (1 << SHIFT_BISHOP[Square::E3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::E3 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::E3 as usize]) as usize];
...
const BISHOP_BB_F3: [Bitboard; (1 << SHIFT_BISHOP[Square::F3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::F3 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::F3 as usize]) as usize];
...
const BISHOP_BB_G3: [Bitboard; (1 << SHIFT_BISHOP[Square::G3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::G3 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::G3 as usize]) as usize];
...
const BISHOP_BB_H3: [Bitboard; (1 << SHIFT_BISHOP[Square::H3 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::H3 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::H3 as usize]) as usize];
...
const BISHOP_BB_A4: [Bitboard; (1 << SHIFT_BISHOP[Square::A4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::A4 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::A4 as usize]) as usize];
...
const BISHOP_BB_B4: [Bitboard; (1 << SHIFT_BISHOP[Square::B4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::B4 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::B4 as usize]) as usize];
...
const BISHOP_BB_C4: [Bitboard; (1 << SHIFT_BISHOP[Square::C4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::C4 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::C4 as usize]) as usize];
...
const BISHOP_BB_D4: [Bitboard; (1 << SHIFT_BISHOP[Square::D4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::D4 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::D4 as usize]) as usize];
...
const BISHOP_BB_E4: [Bitboard; (1 << SHIFT_BISHOP[Square::E4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::E4 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::E4 as usize]) as usize];
...
const BISHOP_BB_F4: [Bitboard; (1 << SHIFT_BISHOP[Square::F4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::F4 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::F4 as usize]) as usize];
...
const BISHOP_BB_G4: [Bitboard; (1 << SHIFT_BISHOP[Square::G4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::G4 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::G4 as usize]) as usize];
...
const BISHOP_BB_H4: [Bitboard; (1 << SHIFT_BISHOP[Square::H4 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::H4 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::H4 as usize]) as usize];
...
const BISHOP_BB_A5: [Bitboard; (1 << SHIFT_BISHOP[Square::A5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::A5 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::A5 as usize]) as usize];
...
const BISHOP_BB_B5: [Bitboard; (1 << SHIFT_BISHOP[Square::B5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::B5 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::B5 as usize]) as usize];
...
const BISHOP_BB_C5: [Bitboard; (1 << SHIFT_BISHOP[Square::C5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::C5 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::C5 as usize]) as usize];
...
const BISHOP_BB_D5: [Bitboard; (1 << SHIFT_BISHOP[Square::D5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::D5 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::D5 as usize]) as usize];
...
const BISHOP_BB_E5: [Bitboard; (1 << SHIFT_BISHOP[Square::E5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::E5 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::E5 as usize]) as usize];
...
const BISHOP_BB_F5: [Bitboard; (1 << SHIFT_BISHOP[Square::F5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::F5 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::F5 as usize]) as usize];
...
const BISHOP_BB_G5: [Bitboard; (1 << SHIFT_BISHOP[Square::G5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::G5 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::G5 as usize]) as usize];
...
const BISHOP_BB_H5: [Bitboard; (1 << SHIFT_BISHOP[Square::H5 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::H5 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::H5 as usize]) as usize];
...
const BISHOP_BB_A6: [Bitboard; (1 << SHIFT_BISHOP[Square::A6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::A6 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::A6 as usize]) as usize];
...
const BISHOP_BB_B6: [Bitboard; (1 << SHIFT_BISHOP[Square::B6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::B6 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::B6 as usize]) as usize];
...
const BISHOP_BB_C6: [Bitboard; (1 << SHIFT_BISHOP[Square::C6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::C6 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::C6 as usize]) as usize];
...
const BISHOP_BB_D6: [Bitboard; (1 << SHIFT_BISHOP[Square::D6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::D6 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::D6 as usize]) as usize];
...
const BISHOP_BB_E6: [Bitboard; (1 << SHIFT_BISHOP[Square::E6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::E6 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::E6 as usize]) as usize];
...
const BISHOP_BB_F6: [Bitboard; (1 << SHIFT_BISHOP[Square::F6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::F6 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::F6 as usize]) as usize];
...
const BISHOP_BB_G6: [Bitboard; (1 << SHIFT_BISHOP[Square::G6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::G6 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::G6 as usize]) as usize];
...
const BISHOP_BB_H6: [Bitboard; (1 << SHIFT_BISHOP[Square::H6 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::H6 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::H6 as usize]) as usize];
...
const BISHOP_BB_A7: [Bitboard; (1 << SHIFT_BISHOP[Square::A7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::A7 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::A7 as usize]) as usize];
...
const BISHOP_BB_B7: [Bitboard; (1 << SHIFT_BISHOP[Square::B7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::B7 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::B7 as usize]) as usize];
...
const BISHOP_BB_C7: [Bitboard; (1 << SHIFT_BISHOP[Square::C7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::C7 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::C7 as usize]) as usize];
...
const BISHOP_BB_D7: [Bitboard; (1 << SHIFT_BISHOP[Square::D7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::D7 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::D7 as usize]) as usize];
...
const BISHOP_BB_E7: [Bitboard; (1 << SHIFT_BISHOP[Square::E7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::E7 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::E7 as usize]) as usize];
...
const BISHOP_BB_F7: [Bitboard; (1 << SHIFT_BISHOP[Square::F7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::F7 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::F7 as usize]) as usize];
...
const BISHOP_BB_G7: [Bitboard; (1 << SHIFT_BISHOP[Square::G7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::G7 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::G7 as usize]) as usize];
...
const BISHOP_BB_H7: [Bitboard; (1 << SHIFT_BISHOP[Square::H7 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::H7 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::H7 as usize]) as usize];
...
const BISHOP_BB_A8: [Bitboard; (1 << SHIFT_BISHOP[Square::A8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::A8 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::A8 as usize]) as usize];
...
const BISHOP_BB_B8: [Bitboard; (1 << SHIFT_BISHOP[Square::B8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::B8 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::B8 as usize]) as usize];
...
const BISHOP_BB_C8: [Bitboard; (1 << SHIFT_BISHOP[Square::C8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::C8 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::C8 as usize]) as usize];
...
const BISHOP_BB_D8: [Bitboard; (1 << SHIFT_BISHOP[Square::D8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::D8 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::D8 as usize]) as usize];
...
const BISHOP_BB_E8: [Bitboard; (1 << SHIFT_BISHOP[Square::E8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::E8 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::E8 as usize]) as usize];
...
const BISHOP_BB_F8: [Bitboard; (1 << SHIFT_BISHOP[Square::F8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::F8 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::F8 as usize]) as usize];
...
const BISHOP_BB_G8: [Bitboard; (1 << SHIFT_BISHOP[Square::G8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::G8 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::G8 as usize]) as usize];
...
const BISHOP_BB_H8: [Bitboard; (1 << SHIFT_BISHOP[Square::H8 as usize]) as usize] = {
    let mut result: [Bitboard; (1 << SHIFT_BISHOP[Square::H8 as usize]) as usize] =
        [0u64; (1 << SHIFT_BISHOP[Square::H8 as usize]) as usize];
